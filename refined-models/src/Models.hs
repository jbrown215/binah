...
notDeriving :: Stmt -> Bool
notDeriving (Deriving _) = False
notDeriving _ = True
...
formatDataEntry entrySet tableName e =
  case e of
    Field v (Simple t) -> tableName ++ (firstCapital v) ++ " :: " ++ "EntityField " ++ tableName ++ " " ++ t
    Field v (Refined tv t refinement) -> tableName ++ (firstCapital v) ++ " :: " ++ "EntityField " ++
